...
#define S(mg, eg) make_score(mg, eg)
  ...
  Score MobilityBonus[][32] = {
    { S(-62,-81), S(-53,-56), S(-12,-30), S( -4,-14), S(  2,  7), S( 11, 13), // Knights
      S( 19, 20), S( 24, 23), S( 28, 28) },
...
TUNE(MobilityBonus);
  ...
  Score MobilityBonusCenter[][21] = {
    { S( 0, 0), S( 0, 0), S( 0, 0), S( 1, 1), S(  2,  2), S(  3,  3), // Knights
      S( 4, 4), S( 6, 6), S( 8, 8) },
...
TUNE(SetRange(-10,40), MobilityBonusCenter);
  ...
  Score MobilityBonusBorder[][9] = {
    { S( 0, 0), S( -2, -4), S( -4, -8), S( -2, -4), S( 0, 0) }, // Knight
    { S( 3, -1), S( 3, 5), S( 0, 0), S( 2,-5), S(-4, 3) }, // Bishops
    { },
    {  }
  };

TUNE(SetRange(-30,20), MobilityBonusBorder);
