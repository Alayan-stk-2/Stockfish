...
Score NBonus[RANK_NB][FILE_NB] =
  { // Knight
   { S(-169,-105), S(-96,-74), S(-80,-46), S(-79,-18), S(-79,-18), S(-80,-46), S(-96,-74), S(-169,-105) },
   { S( -79, -70), S(-39,-56), S(-24,-15), S( -9,  6), S( -9,  6), S(-24,-15), S(-39,-56), S( -79, -70) },
   { S( -64, -38), S(-20,-33), S(  4, -5), S( 19, 27), S( 19, 27), S(  4, -5), S(-20,-33), S( -64, -38) },
   { S( -28, -36), S(  5,  0), S( 41, 13), S( 47, 34), S( 47, 34), S( 41, 13), S(  5,  0), S( -28, -36) },
   { S( -29, -41), S( 13,-20), S( 42,  4), S( 52, 35), S( 52, 35), S( 42,  4), S( 13,-20), S( -29, -41) },
   { S( -11, -51), S( 28,-38), S( 63,-17), S( 55, 19), S( 55, 19), S( 63,-17), S( 28,-38), S( -11, -51) },
   { S( -67, -64), S(-21,-45), S(  6,-37), S( 37, 16), S( 37, 16), S(  6,-37), S(-21,-45), S( -67, -64) },
   { S(-200, -98), S(-80,-89), S(-53,-53), S(-32,-16), S(-32,-16), S(-53,-53), S(-80,-89), S(-200, -98) }
  };
  ...
  for (Piece pc = W_PAWN; pc <= W_KING; ++pc)
  {
      ...
      for (Square s = SQ_A1; s <= SQ_H8; ++s)
      {
          ...
          psq[ pc][ s] = score + (type_of(pc) == PAWN   ? PBonus[rank_of(s)][file_of(s)] :
                                  type_of(pc) == KNIGHT ? NBonus[rank_of(s)][file_of(s)] :
...
TUNE(SetRange(-220, 80), NBonus, init);
