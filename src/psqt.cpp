...
constexpr Score NBonus[RANK_NB][FILE_NB] =
  { // Knight
   { S(-168,-111), S(-98, -67), S(-81,-53), S(-69,-16), S(-78,-18), S(-80,-35), S(-95,-74), S(-160,-104) },
   { S( -83, -77), S(-49, -71), S(-24, -7), S(-24,  0), S(-10, 10), S(-28,-16), S(-30,-66), S( -65, -60) },
   { S( -64, -23), S( -8, -27), S( -5, -2), S( 17, 23), S( 22, 24), S(  8, -3), S(-16,-34), S( -69, -29) },
   { S( -38, -41), S(  1, -16), S( 40, 25), S( 28, 34), S( 45, 40), S( 38, 15), S(  8,  0), S( -32, -21) },
   { S( -27, -40), S( 17, -17), S( 43,-10), S( 60, 48), S( 49, 25), S( 29,  8), S( 15, -9), S( -38, -38) },
   { S( -17, -42), S( 19, -44), S( 59,-20), S( 70,  9), S( 50, 10), S( 67,-12), S( 33,-44), S(  -7, -52) },
   { S( -79, -59), S(-17, -45), S(  1,-34), S( 26, 18), S( 40,  7), S( 14,-22), S(-22,-38), S( -70, -63) },
   { S(-206, -95), S(-78,-101), S(-53,-59), S(-28,-10), S(-34,-19), S(-46,-54), S(-82,-94), S(-191, -97) }
  };
