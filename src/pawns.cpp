...
namespace {
  ...
  int Connected[RANK_NB] = { 0, 6, 8, 12, 27, 43, 83 };

TUNE(SetRange(-30,120), Backward, Isolated, WeakLever, WeakUnopposed, DoubledEdge, Doubled, DoubledIsolated, DoubledContact, Connected);
